...
You can install the Mobile App Template via the command line with either `curl` or `wget` which will run this [Shell Script](https://raw.githubusercontent.com/manifestinteractive/mobile-app-template/stable/build/scripts/install.sh).
...
If you would like to manually install this application, please follow the instructions in the [Installation Script](https://raw.githubusercontent.com/manifestinteractive/mobile-app-template/stable/build/scripts/install.sh).
...
The `mobile-app-template` app will open in your default browser at [http://127.0.0.1:8080](http://127.0.0.1:8080)
